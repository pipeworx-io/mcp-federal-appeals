...
/**
 * Federal appellate dockets — US federal court dockets.
 *
...
const tools: McpToolExport['tools'] = [
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        party: { type: 'string', description: 'Party name or a distinctive part of it, e.g. "Oracle".' },
        court: { type: 'string', description: 'Optional circuit id, e.g. "ca9", "ca2", "cafc", "scotus".' },
...
const FILTERS = { court_class: 'federal_appellate' };
